...
def build_montages(image_list, image_shape, montage_shape):
    ...
    montage_image = np.zeros(shape=(image_shape[0] * montage_shape[0], image_shape[1] * montage_shape[1], 3),
                          dtype=np.float64)
    cursor_pos = [0, 0]
    start_new_img = False
    for img in image_list:
        ...
        montage_image[cursor_pos[0]:cursor_pos[0] + image_shape[0], cursor_pos[1]:cursor_pos[1] + image_shape[1], ] = img
        cursor_pos[1] += image_shape[1]  # increment cursor x position
