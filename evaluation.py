...
from datasets import SintelDataset, DataLoader, resize_pyramid
import pickle
FLOW_SCALE = 20.0
smallflow = 0.0
...
pwc.train()
Bsize = 4
SintelFinal = SintelDataset(render="clean", torchify=True, cropsize=None)
eval_loader = DataLoader(dataset=SintelFinal, batch_size=Bsize, shuffle=False, drop_last=False,)
mepe_frs2, mepe_level2 = eval_mepe(pwc, eval_loader)
pickle.dump({"mepe_hrs":mepe_frs2, "mepe_level":mepe_level2}, open("..\\Sintel_clean_model_chairs-things_EPE_lvl.pk", "wb"))
